...
async function handleAddNewTask(event) {
    ...
    await (0, _tasks.createTask)(newTask);
    (0, _board.loadBoard)();
...
parcelHelpers.export(exports, "getTeamMembers", ()=>getTeamMembers);
// Skapa en ny teammedlem
parcelHelpers.export(exports, "createTeamMember", ()=>createTeamMember);
var _firebase = require("../firebase");
var _database = require("firebase/database");
async function getTeamMembers() {
    const membersRef = (0, _database.ref)((0, _firebase.db), "members");
    const snapshot = await (0, _database.get)(membersRef);
...
async function createTeamMember(member) {
    const membersRef = (0, _database.ref)((0, _firebase.db), "members");
    const newMemberRef = (0, _database.push)(membersRef);
    await (0, _database.set)(newMemberRef, member);
}
...
},{"d07263985281b344":"d5jf4","./postinstall.mjs":"2IZ9s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports,__globalThis) {
...
},{}],"2IZ9s":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _database = require("firebase/database");
var _firebase = require("../firebase"); // Firebase-konfigurationen
function getTasks() {
...
async function updateTask(taskId, updatedTask) {
    const taskRef = (0, _database.ref)((0, _firebase.db), `/tasks/${taskId}`);
    await (0, _database.update)(taskRef, updatedTask);
}
